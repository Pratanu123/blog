...
export function WelcomeWitch({ className = "" }: WelcomeWitchProps) {
  return (
    <div
      className={`home-welcome-witch ${className}`.trim()}
      role="img"
      aria-label="A witch holding a lantern. Hover to reveal her wand."
    >
